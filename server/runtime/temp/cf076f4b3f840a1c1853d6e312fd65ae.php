<?php /*a:1:{s:47:"/server/application/admin/view/index/index.html";i:1765987101;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="/static/plug/layui-admin/dist/layuiadmin/style/admin.css" media="all">
    <?php echo $js_code; ?>
    <style>
...
<div id="LAY_app">
            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    ...
                    <dl class="layui-nav-child">
                        <dd><a lay-href="<?php echo url('my/password'); ?>">修改密码</a></dd>
                        <hr>
                        <dd style="text-align: center;"><a href="<?php echo url('account/logout'); ?>">退出</a></dd>
                    </dl>
                </li>
        ...
        <div class="layui-side layui-side-menu first-nav">
            <div class="layui-side-scroll">
                <div class="layui-logo">
                    <img style="height:20px;width: 77px" src="<?php echo htmlentities($config['backstage_logo']); ?>">
                </div>
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
                    <?php if(is_array($menu) || $menu instanceof \think\Collection || $menu instanceof \think\Paginator): $i = 0; $__LIST__ = $menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <li data-id="<?php echo htmlentities($vo['id']); ?>" class="layui-nav-item">
                        <a href="javascript:" lay-tips="<?php echo htmlentities($vo['name']); ?>">
    ...
    <div class="layadmin-pagetabs" id="LAY_app_tabs">
        ...
        <div class="layui-tab" lay-unauto lay-allowClose="true" lay-filter="layadmin-layout-tabs">
            <ul class="layui-tab-title" id="LAY_app_tabsheader">
                <li lay-id="" lay-attr="<?php echo url('index/stat'); ?>" class="layui-this">工作台</li>
            </ul>
        </div>
    </div>
    ...
    <div class="layui-body hide-second-nav" id="LAY_app_body">
        <div class="layadmin-tabsbody-item layui-show">
            <iframe src="<?php echo url('index/stat'); ?>" frameborder="0" class="layadmin-iframe"></iframe>
        </div>
    </div>
...
<script>
    layui.config({
        ...
        // 展示二级菜单 fzr
        localStorage.setItem("menus", '<?php echo json_encode($menu); ?>');

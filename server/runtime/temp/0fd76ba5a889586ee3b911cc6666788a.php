<?php /*a:2:{s:47:"/server/application/admin/view/goods/lists.html";i:1765987101;s:43:"/server/application/admin/view/layout1.html";i:1765987101;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-card">
        ...
        <div class="layui-tab layui-tab-card" lay-filter="tab-all">
            ...
            <ul class="layui-tab-title">
                ...
                <li data-type='2' >仓库中商品(<?php echo htmlentities($statistics['warehouse']); ?>)</li>
                <li data-type='3' >库存预警商品(<?php echo htmlentities($statistics['warn']); ?>)</li>
                ...
                <div class="layui-card">
                    <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                        <div class="layui-form-item type">
                            ...
                            <div class="layui-inline">
                                <button class="layui-btn layui-btn-sm layuiadmin-btn-goods <?php echo htmlentities($view_theme_color); ?>" lay-submit lay-filter="goods-search">查询</button>
                    ...
                    <div class="layui-card-body">
                        <div style="padding-bottom: 10px;" class="add">
                            <button class="layui-btn layui-btn-sm layuiadmin-btn-goods <?php echo htmlentities($view_theme_color); ?>" data-type="add">发布商品</button>
                            <button id="lower" class="layui-btn layui-btn-sm layuiadmin-btn-goods <?php echo htmlentities($view_theme_color); ?>" data-type="lower">下架</button>
...
<script>
    layui.config({
        ...
        var active = {
            ...
            add: function(){
                var index = layer.open({
                    type: 2
                    ,title: '添加商品'
                    ,content: '<?php echo url("goods/add"); ?>'
                    ,area: ['90%', '90%']
                    ,btn: ['保存', '取消']
                    ,maxmin: true
            ...
            lower: function(){
                ...
                // 提交数据
                like.ajax({
                    url:'<?php echo url("goods/lowerStatus"); ?>',
                    data:{"ids":ids},
                    type:"post",
                    success:function(res) {
                        if(res.code === 1) {
            ...
            upper: function(){
                ...
                // 提交数据
                like.ajax({
                    url:'<?php echo url("goods/upperStatus"); ?>',
                    data:{"ids":ids},
                    type:"post",
                    success:function(res) {
                        if(res.code === 1) {
        ...
        table.on('tool(goods-lists)', function(obj){
            ...
            if(obj.event === 'edit'){
                ...
                var index = layer.open({
                    type: 2
                    ,title: '编辑商品'
                    ,content: '<?php echo url("goods/edit"); ?>?goods_id='+id
                    ,area: ['90%', '90%']
                    ,btn: ['保存', '取消']
                    ,maxmin: true
                    ,yes: function(index, layero){
        ...
        function getList(type) {
            layui.define(['table', 'form'], function(exports){
                ...
                table.render({
                    id:'goods-lists'
                    ,elem: '#goods-lists'
                    ,url: '<?php echo url("goods/lists"); ?>?type='+type  //模拟接口
                    ,cols: [cols]
                    ,page:true
                    ,text: {none: '暂无数据！'}
        ...
        function changeFields(id,fields,value){
            $.ajax({
                url:'<?php echo url("goods/changeFields"); ?>',
        ...
        function updateTabNumber() {
            like.ajax({
                url: '<?php echo url("goods/totalCount"); ?>',
                data: {},
                type: "GET",
                success: function (res) {
                    if (res.code === 1) {

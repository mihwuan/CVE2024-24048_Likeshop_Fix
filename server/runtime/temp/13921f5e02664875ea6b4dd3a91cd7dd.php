<?php /*a:1:{s:49:"/server/application/admin/view/account/login.html";i:1765987101;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="login">
    <div class="logo">
        <img style="width: auto;height: 42px" src="<?php echo htmlentities($config['login_logo']); ?>"/>
    </div>
    <div class="login-form-box">
        <div class="login-left">
            <div class="login-left-img">
                <img  src="<?php echo htmlentities($config['admin_image']); ?>"/>
            </div>
        </div>
        <div class="login-right">
            <div class="login-form layui-form">
                <div class="login-title">
                    <?php echo htmlentities($config['admin_title']); ?>
                </div>
                <div class="form-box-item">
                    ...
                    <div>
                        <input type="text" name="account" lay-verify="required" lay-vertype="tips"
                               ...
                               placeholder="请输入账号" value="<?php echo htmlentities($account); ?>"/>
                    </div>
                </div>
                <div class="form-box-item">
                    <div class="icon">
                ...
                <div class="form-box-item">
                    ...
                    <div style="display: flex; align-items: center; justify-content: space-between;">
                        ...
                        <img style="height: 36px;width: 126px;" src="<?php echo captcha_src(); ?>"
...
<script>
    ...
    layui.config({
        ...
        function login(obj) {
            like.ajax({
                url: '<?php echo url("account/login"); ?>' //实际使用请改成服务端真实接口
                , data: obj.field
                , type: 'post'

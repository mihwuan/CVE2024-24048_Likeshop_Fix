<?php /*a:2:{s:49:"/server/application/admin/view/crontab/lists.html";i:1765987101;s:43:"/server/application/admin/view/layout1.html";i:1765987101;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    layui.config({
        ...
        table.render({
            elem: '#crontab-lists'
            , url: '<?php echo url("crontab/lists"); ?>' //模拟接口
            , cols: [[
        ...
        table.on('tool(crontab-lists)', function (obj) {
            ...
            switch (operation) {
                ...
                case 'restart':
                    ...
                    like.ajax({
                        url: '<?php echo url("crontab/operation"); ?>',
                        data: data,
                        type: "post",
                ...
                case 'edit':
                    layer.open({
                        type: 2
                        ,title: '编辑系统任务'
                        ,content: '<?php echo url("crontab/edit"); ?>?id='+id
                        ,area: ['90%', '90%']
                        ,btn: ['确定', '取消']
        ...
        var active = {
            add: function(){
                layer.open({
                    type: 2
                    ,title: '添加系统任务'
                    ,content: '<?php echo url("crontab/add"); ?>'
                    ,area: ['90%', '90%']
                    ,btn: ['确定', '取消']
                    ,yes: function(index, layero){
                        var iframeWindow = window['layui-layer-iframe'+ index]

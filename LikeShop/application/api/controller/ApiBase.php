...
class ApiBase extends Controller
{
     ...
     * @param int $httpCode
     */
    protected function _error($msg = '', $data = [], $code = 0, $show = 1, array $header = [], $httpCode = 200)
    {
        $type = $this->getResponseType();
        $time = Debug::getUseTime();
        $result = [
        ...
        $response = Response::create($result, $type)->header($header)->code($httpCode)->options(['jump_template' => $this->app['config']->get('dispatch_error_tmpl')]);

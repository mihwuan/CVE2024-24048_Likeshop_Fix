<?php /*a:2:{s:47:"/server/application/admin/view/order/lists.html";i:1765987101;s:43:"/server/application/admin/view/layout1.html";i:1765987101;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="layui-card">
                                ...
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-block">
                                        <select name="order_type" id="order_type">
                                            ...
                                            <?php foreach($order_type as $item => $val): ?>
                                ...
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-block">
                                        <select name="delivery_type" id="delivery_type">
                                            <option value="">全部</option>
                                            <?php foreach($delivery_type as $item => $val): ?>
                                            <option value="<?php echo htmlentities($item); ?>"><?php echo htmlentities($val); ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                    ...
                    <div class="layui-card-body">
                        ...
                        <script type="text/html" id="user">
                            <img src="{{d.user.base_avatar}}" style="height:80px;width: 80px" class="image-show">
...
<script>
    layui.config({
        ...
        function getList(type) {
            table.render({
                elem: '#order-lists'
                , url: '<?php echo url("order/lists"); ?>?type=' + type
                , cols: [[
                    {field:'id',title: 'id',width:60,align: 'center'}
                    , {field: 'order', title: '订单信息', align: 'center',templet:'#order',width:230}
                    , {field: 'user', title: '会员信息', align: 'center',templet:'#user',width:310}
                    ...
                    , {fixed: 'right', title: '操作', width: 280, align: 'center', toolbar: '#order-operation'}
                ]]
                , page: true
                , text: {none: '暂无数据！'}
        ...
        table.on('tool(order-lists)', function (obj) {
            ...
            if(obj.event === 'express'){
                layer.open({
                    type: 2
                    ,title: '订单发货'
                    ,content: '<?php echo url("order/express"); ?>?id='+id
                    ,area: ['90%', '90%']
                    ,yes: function(index, layero){
            ...
            if(obj.event === 'remarks') {
                ...
                like.ajax({
                    url: '<?php echo url("order/remarks"); ?>'
                    , data: {'id': id}
                    , type: 'get'
                    , success: function (res) {
                        if (res.code === 1) {

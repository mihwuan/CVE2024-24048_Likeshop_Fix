<?php /*a:2:{s:55:"/server/application/admin/view/goods_comment/lists.html";i:1765987101;s:43:"/server/application/admin/view/layout1.html";i:1765987101;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <ul class="layui-tab-title">
                ...
                <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            <button class="layui-btn layui-btn-sm layuiadmin-btn-unit <?php echo htmlentities($view_theme_color); ?>" lay-submit lay-filter="comment-search">查询</button>
                ...
                <div class="layui-card-body">
                    <div class="layui-card">
                        ...
                        <script type="text/html" id="comment_image">
                            ...
                            <img src="{{item}}" alt="评论图片" class="image-show" style="width:50px;height:50px;float:left;margin-right:5px;">
                            {{#  }); }}
                        </script>
    ...
    layui.config({
        ...
        function getList(type) {
            table.render({
                ...
                , url: '<?php echo url("goods_comment/lists"); ?>?type='+type
                , cols: [[
                    ...
                    {field: 'commentImage', title: '评论图片',width:200, templet:"#comment_image"},
        ...
        table.on('tool(goods_comment-lists)', function(obj){
            ...
            if(obj.event === 'del'){
                ...
                layer.confirm('确定删除评论:<span style="color: red">'+name+"</span>", function(index){
                    like.ajax({
                        url:'<?php echo url("goods_comment/del"); ?>',
                        data:{delData:id},
                        type:"post",
            ...
            if(obj.event === 'status_switch'){
                ...
                if (info_state == '显示'){
                    ...
                    layer.confirm('确认隐藏评论:<span style="color: red">'+name+'</span>', function(index){
                        like.ajax({
                            url:'<?php echo url("goods_comment/switchStatus"); ?>',
            ...
            if(obj.event === 'reply'){
                ...
                layer.open({
                    type: 2
                    ,title: '商品评论'
                    ,content: '<?php echo url("goods_comment/reply"); ?>?id='+id
                    ,area: ['60%','60%']
                    ,btn: ['确定', '取消']
                    ,yes: function(index, layero){
                        ...
                        iframeWindow.layui.form.on('submit('+ submitID +')', function(data){
                            var field = data.field;
                            $.ajax({
                                url:'<?php echo url("goods_comment/reply"); ?>',
                                data:field,
                                type:"post",
                                success:function(res)
                                {
